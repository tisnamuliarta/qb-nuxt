    ...
    <v-col cols="12" class="mt-0">
      <div class="pl-4 pt-2">
        <v-chip
          ...
          label
          small
          @click="$router.push({ path: '/app/contact/list' })"
        >
...
export default {
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      const vm = this
      this.$axios
        .get('/api/bp/contacts/' + this.$route.query.id, {
          params: {
            options: vm.options,
        ...
        .then((res) => {
          ...
          this.balance = (this.form.type === 'Customer') ? this.form.sell_account.balance : this.form.purchase_account.balance
