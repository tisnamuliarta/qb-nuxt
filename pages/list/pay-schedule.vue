        ...
        >
          <template #top>
            ...
            <LazyMainToolbar
              ...
              show-new-data
              new-data-text="New Pay Schedule"
              show-back-link
              show-batch-action
              @emitData="emitData"
              @newData="newData"
...
export default {
  ...
  data() {
    return {
      ...
      itemAccounts: [],
      itemCategory: ['Every Week', 'Every Month'],
      allData: [],
      form: {},
      defaultItem: {},
      options: {},
      headers: [
        ...
        { text: this.$t('Pay date'), value: 'pay_date' },
        { text: this.$t('End Pay Period'), value: 'end_pay_period' },
